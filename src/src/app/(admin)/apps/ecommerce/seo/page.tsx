...
import { Search, TrendingUp, Globe, Link, AlertCircle, Check, ShoppingBag, Tag, Star } from 'lucide-react'
    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
        {[
          ...
          {l:'Total Clicks',  v:totalClicks.toLocaleString(), c:COLOR.primary},
