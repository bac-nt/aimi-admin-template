...
import { Bold, Check, Code, Italic, List, Plus, Upload, X } from 'lucide-react'
...
export default function AddProductPage() {
  ...
  if (done) {
    return (
      <>
        ...
        description="Add a new product to your catalog"><Button variant="outline" onClick={()=>{setSaving(true);setTimeout(()=>setSaving(false),800)}}>Save Draft</Button><Button loading={saving} onClick={validate}><Check size={14}/>Publish Product</Button></div>}/>
  ...
  return (
    <>
      <PageBanner title="Add Product" breadcrumbs={[{label:'Home',href:'/'},{label:'Ecommerce'},{label:'Products',href:'/apps/ecommerce/list'},{label:'Add Product'}]}
        action={<div className="flex gap-2"><Button variant="outline" onClick={()=>{setSaving(true);setTimeout(()=>setSaving(false),800)}}>Save Draft</Button><Button loading={saving} onClick={validate}><Check size={14}/>Publish Product</Button></div>}/>
        ...
        <div className="space-y-5">
          ...
          <div className="card p-5 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Toggle checked={status} onChange={setStatus} size="sm"/>
            </div>
