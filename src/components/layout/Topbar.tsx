...
import { AlignJustify, Bell, BookOpen, Bot, Calendar, Check, ChevronDown, Kanban, LogOut, Mail, Menu, MessageSquare, Moon, PanelLeft, Receipt, Search, Settings, ShoppingCart, StickyNote, Store, Sun, User, X } from 'lucide-react'
    ...
    <>
      ...
      >
        ...
        <div className="relative hidden md:block">
          ...
          {panel === 'apps' && (
            <div className="absolute left-0 top-full mt-1.5 w-52 card py-1.5 animate-slide-down z-50 shadow-xl"
        ...
        <div className="flex items-center gap-0.5">
          ...
          <div className="relative">
            ...
            {panel === 'cart' && (
              <div className="absolute right-0 top-full mt-2 w-72 card animate-slide-down z-50 shadow-xl"
                style={{ boxShadow: 'var(--shadow-dropdown)' }}>
          ...
          <div className="relative">
            ...
            {panel === 'notif' && (
              <div className="absolute right-0 top-full mt-2 card animate-slide-down z-50 shadow-xl"
          ...
          <div className="relative ml-1">
            ...
            {panel === 'user' && (
              <div className="absolute right-0 top-full mt-2 w-52 card animate-slide-down z-50 shadow-xl"
                style={{ boxShadow: 'var(--shadow-dropdown)' }}>
      ...
      <div
        ...
        style={{ width: 320, background: 'var(--card)', borderLeft: '1px solid var(--border)', boxShadow: '-4px 0 24px rgba(0,0,0,0.1)', zIndex: 9999, transition: 'transform 220ms cubic-bezier(0.4,0,0.2,1)', willChange: 'transform' }}
      >
      ...
      {/* Dropdown overlay (transparent click-catcher) */}
      {panel && panel !== 'settings' && (
        <div className="fixed inset-0 z-20" onClick={close} />
      )}
      {/* Settings: transparent click-outside, NO dark overlay */}
      {panel === 'settings' && (
        <div className="fixed inset-0" style={{zIndex:9997}} onClick={close}/>
      )}
    </>
  )
}
